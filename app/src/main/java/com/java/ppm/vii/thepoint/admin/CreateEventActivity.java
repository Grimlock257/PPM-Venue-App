...
/**
 * Activity for creation of a new event
 */
public class CreateEventActivity extends AppCompatActivity {
    ...
    private void createEvent() {
        ...
        try {
            ...
            editTextFormEventPrice.setError("Price can only be numbers!");
            editTextFormEventPrice.requestFocus();
            return;
        }
        ...
        NetworkRequest request = new NetworkRequest(API.INSERT.getURL(), params, HTTPMethod.POST);
        request.execute();
    }
