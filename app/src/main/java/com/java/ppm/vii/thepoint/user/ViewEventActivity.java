        ...
        llist = new ArrayList<>();
           ...
           // post
            ...
            for(i = 0; i < j;i++)
            {
                ...
                List.add(new VenueCardViewArray("Venue: " + i, "EventTime", "", Uri.parse("http://goo.gl/gEgYUd"), 0/*, R.drawable.ic_launcher_foreground*/)); //Add a Null Check to ensure that if the Arrylist<img> returnsnull that a text or image placeholder is used to avoid a potential nullpointer)
            }
